...
class JFPingManager: NSObject {
    ...
    /// - Returns: 最快的ip
    class func getFastestAddress(addressList: [String], finished: @escaping (_ ipAddress: [String : [Double]]?) -> ()) -> () {
        ...
        for  (i, address) in addressList.enumerated() {
...
//            finished(String(format: "%.fms", minAvg))
